...
export default grapesjs.plugins.add('gjs-preset-newsletter', (editor, opts) => {
  ...
  // let modalImportHeaderTemplate = `
  //   <div class="gjs-mdl-headerActionArea">
  //     <span class="gjs-import-label">Select an existing Campaign:</span>
  //     <select id="selImportTemplate" class="selImportTemplate">
  //         <option></option>
  ...
  let defaults = {
    ...
    cmdBtnCleanAll: 'Empty Canvas',
    modalTitleImport: 'Import template',
    importHeaderContent: 'Import Template',
    modalTitleExport: 'Export template',
    modalLabelImport: '',
    modalLabelExport: '',
    modalBtnImport: 'Import',
    modalEditHtml: 'Edit HTML',
